...
- [Parallel API calls using Coroutines, having different return types](https://proandroiddev.com/parallel-api-calls-using-coroutines-having-different-return-types-4d269a1b88d4?source=rss-c403e2b09f16------2)
